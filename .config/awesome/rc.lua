...
tags = {
	names = {"mail", "www", "files", 4, 5, 6, 7, 8, "video"},
	layout = {layouts[11], layouts[11], layouts[11], layouts[6], layouts[6], layouts[1], layouts[1], layouts[1], layouts[11]}
}
...
awful.util.spawn_with_shell("gnome-commander")
